  ...
  if (isNode) {
    ...
    try {
      ...
      switch (adapterId) {
        ...
        case 'jsx_react': content = (await import('../templates/jsx_react.txt?raw')).default; break;
        case 'jsx_solid': content = (await import('../templates/jsx_solid.txt?raw')).default; break;
        default: return null
      }
      return content
    } catch (e) {
